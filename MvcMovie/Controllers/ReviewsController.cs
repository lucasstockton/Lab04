...
namespace MvcMovie.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,myreview")] Reviews reviews)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,myreview")] Reviews reviews)
        {
            if (id != reviews.ID)
            {
                return NotFound();
